...
public class VnPayServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // Lấy giá trị từ request và loại bỏ cả dấu phẩy và dấu chấm
     String amountString = request.getParameter("amount").replace(",", "").replace(".", "");

// Chuyển đổi chuỗi thành kiểu số nguyên và nhân với 100
